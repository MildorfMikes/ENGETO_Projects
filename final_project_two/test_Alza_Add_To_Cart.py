# Test #2 Milan Mike Klos

#  open alza - search iPhone - add to cart - continue in cart - dont buy anything recommended - close
...
with sync_playwright() as p:
    ...
    # Click "Do košíku" button
    page.locator(".js-buy-button").click()

    # Wait for 1 second before closing the browser
    page.wait_for_timeout(1000)

    # Close vendor notification
    page.click("[id='vendor-close']")
    
    # Wait for 1 second before closing the browser
    page.wait_for_timeout(1000)

    # Click "Přidat do košíků" button
    page.click("[id='varBToBasketButton']")

    # Wait for 1 second before closing the browser
    page.wait_for_timeout(1000)

    # Click "Pokračovat" v košíku
    page.locator(".js-button-order-continue").click()

    # Wait for 1 second before closing the browser
    page.wait_for_timeout(1000)

    # Click "Nepřidávat nic button"
    page.locator(".js-close-button close-button")
